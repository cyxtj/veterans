...
class MissionAlgor(db.Model):
	...
	LEMIid = db.Column(db.String(36), db.ForeignKey('learnMission.LEMIid'))
...
class MissionPar(db.Model):
	...
	MIALid = db.Column(db.String(36), db.ForeignKey('MissionAlgor.MIALid'))
...
class ancientBook(db.Model):
	...
	REBOid = db.Column(db.String(36), db.ForeignKey('readBook.REBOid'))
...
class background(db.Model):
	...
	STSTid = db.Column(db.String(36), db.ForeignKey('studyStory.STSTid'))
...
class diagItem(db.Model):
	...
	DIREid = db.Column(db.String(36), db.ForeignKey('diagRecipe.DIREid'))
...
class diagnose(db.Model):
	...
	CASEid = db.Column(db.String(36), db.ForeignKey('dCase.CASEid'))
	CDISid = db.Column(db.String(36), nullable=False, default=' ')
...
class dtmpExamination(db.Model):
	...
	DTMPid = db.Column(db.String(36), db.ForeignKey('dTemplate.DTMPid'))
	EXAMid = db.Column(db.String(36), db.ForeignKey('examination.EXAMid'))
	sequence = db.Column(db.Integer, nullable=False)
	illustration = db.Column(db.text, nullable=False)
	#primary key(DTEXid)
...
class feature(db.Model):
	...
	DASEid = db.Column(db.String(36), db.ForeignKey('dataSet.DASEid'))
	code = db.Column(db.String(20), nullable=False)
	name = db.Column(db.String(50), nullable=False)
...
class genre(db.Model):
	...
	INSTid = db.Column(db.String(36), db.ForeignKey('inheritStudy.INSTid'))
...
class rediagnose(db.Model):
	...
	CAANid = db.Column(db.String(36), db.ForeignKey('caseAnalysis.CAANid'))
...
class semiotic(db.Model):
	...
	CDISid = db.Column(db.String(36), db.ForeignKey('cDisease.CDISid'))
	code = db.Column(db.String(20), nullable=False)
...
class student(db.Model):
	...
	TEEXid = db.Column(db.String(36), db.ForeignKey('teachExperience.TEEXid'))
	name = db.Column(db.String(20), nullable=False)
