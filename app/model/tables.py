...
class ChineseDisease(db.Model):
    ...
    def __init__(CDISid, code, name, parentcode, level, classical, SPETid, illustration, createDay, optrid, state):
        self.CDISid = CDISid
        self.code = code
        self.name = name
...
class dCase(db.Model):
    ...
    def __init__(CASEid, SPETid, DTMPid, code, outpatientCode, caseKind, name, age, month, gender, nationality, personSort, afflication, job, tel, address, birthplace, liveplace, education, marriage, ohistory, phistory, fhistory, allergy, extraMed, nhistory, mresult, vresult, illustration, state, createDay, optrid, hasFile, preState):
        self.CASEid = CASEid
        self.SPETid = SPETid
        self.DTMPid = DTMPid
        self.code = code
...
class dMethod(db.Model):
    ...
    def __init__(DMETid, code, name, parentcode, level, classical, SPETid, illustration, createDay, optrid, state):
        self.DMETid = DMETid
        self.code = code
        self.name = name
        self.parentcode = parentcode
...
class dTemplate(db.Model):
    ...
    def __init__(DTMPid, code, name, classCdis, classDmet, CDISid, WDISid, SEMCid, DMETid, takeWay, drugForm, SPETid, illustration, createDay, optrid, state):
        self.DTMPid = DTMPid
        self.code = code
        self.name = name
...
class diagExam(db.Model):
    ...
    def __init__(DIEXid, DIAGid, EXAMid, value, date, address, illustration, sequence):
        self.DIEXid = DIEXid
        self.DIAGid = DIAGid
        self.EXAMid = EXAMid
        self.value = value
...
class diagItem(db.Model):
    ...
    def __init__(DIITid, DIREid, dru_DRUGid, DRUGid, quality, sequence, illustration):
        self.DIITid = DIITid
        self.DIREid = DIREid
...
class diagRecipe(db.Model):
    ...
    def __init__(DIREid, DIAGid, FREPid, isCustomed, name, doctorAdvice, drugForm, takeWay, quality, produceMethod, usage):
        self.DIREid = DIREid
        self.DIAGid = DIAGid
        self.FREPid = FREPid
...
class diagSymptom(db.Model):
    ...
    def __init__(DISYid, SYPMid, DIAGid, value, illustration, sequence):
        self.DISYid = DISYid
        self.SYPMid = SYPMid
        self.DIAGid = DIAGid
        self.value = value
...
class diagnose(db.Model):
    ...
    def __init__(DIAGid, CASEid, CDISid, CDISid2, WDISid, WDISid2, SEMCid, SEMCid2, SEMCid3, DMETid, DMETid2, DMETid3, DIAGno, DIAGnum, DIAGday, lunarDay, solarTerm, DIAway, majorSue, illustration, optrid, createDay, westernMed, other, preSEMCid):
        self.DIAGid = DIAGid
        self.CASEid = CASEid
        self.CDISid = CDISid
...
class drug(db.Model):
    ...
    def __init__(DRUGid, code, name, unit, alias, py, wb, classical, SPETid, illustration, createDay, optrid, state):
        self.DRUGid = DRUGid
        self.code = code
        self.name = name
        self.unit = unit
...
class dtmpExamination(db.Model):
    ...
    def __init__(DTEXid, DTMPid, EXAMid, sequence, illustration):
        self.DTEXid = DTEXid
        self.DTMPid = DTMPid
        self.EXAMid = EXAMid
        self.sequence = sequence
...
class dtmpSymptom(db.Model):
    ...
    def __init__(DTSYid, DTMPid, SYPMid, isFirst, sequence, illustration):
        self.DTSYid = DTSYid
        self.DTMPid = DTMPid
        self.SYPMid = SYPMid
...
class examination(db.Model):
    ...
    def __init__(EXAMid, code, name, abbreviation, kind, normalValue, hasFile, classical, SPETid, illustration, createDay, optrid, state):
        self.EXAMid = EXAMid
        self.code = code
        self.name = name
...
class fixedrecipe(db.Model):
    ...
    def __init__(FREPid, code, name, effect, py, wb, classical, SPETid, illustration, createDay, optrid, state):
        self.FREPid = FREPid
        self.code = code
        self.name = name
        self.effect = effect
...
class fixedrecipeItem(db.Model):
    ...
    def __init__(FRITid, DRUGid, FREPid, quality, sequence, illustration):
        self.FRITid = FRITid
        self.DRUGid = DRUGid
        self.FREPid = FREPid
        self.quality = quality
...
class integratedSym(db.Model):
    ...
    def __init__(INSYid, SYPMid, name, valSort, sequence):
        self.INSYid = INSYid
        self.SYPMid = SYPMid
        self.name = name
...
class semiotic(db.Model):
    ...
    def __init__(SEMCid, CDISid, code, groupCode, name, classical, SPETid, illustration, createDay, optrid, state):
        self.SEMCid = SEMCid
        self.CDISid = CDISid
        self.code = code
...
class symptom(db.Model):
    ...
    def __init__(SYPMid, code, name, parentcode, level, kind, sort, valSort, hasFile, classical, SPETid, illustration, createDay, optrid, state):
        self.SYPMid = SYPMid
        self.code = code
        self.name = name
        self.parentcode = parentcode
...
class WestenDisease(db.Model):
    ...
    def __init__(WDISid, code, name, parentcode, level, classical, SPETid, illustration, createDay, optrid, state):
        self.WDISid = WDISid
        self.code = code
        self.name = name
        self.parentcode = parentcode
